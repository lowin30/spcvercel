...
SELECT
  ...
  (SELECT COUNT(*) FROM public.vista_admin_pf_enviado_sin_actividad WHERE umbral = 'alerta_20d') AS pf_enviado_sin_actividad_20d_count,
  (SELECT COUNT(*) FROM public.vista_admin_pf_enviado_sin_actividad WHERE umbral = 'auto_cierre_30d') AS pf_enviado_sin_actividad_30d_count
