...
export function PresupuestoDetailClient({ presupuesto, userRole }: PresupuestoDetailClientProps) {
  ...
  const handleAprobar = async () => {
    ...
    if (sessionStatus !== 'authenticated') {
      toast({
        ...
        description: "Solo los administradores pueden enviar presupuestos base.",
        variant: "destructive",
      })
      return
    }
    ...
    try {
      ...
      if (result && result.success === false) {
        ...
        toast({
          ...
          description: "El presupuesto base ha sido enviado correctamente y el estado de la tarea ha sido actualizado.",
        })
  ...
  const handleAnularAprobacion = async () => {
    ...
    if (!isAdmin) {
      toast({
        title: "Permiso denegado",
        description: "Solo los usuarios con rol admin pueden anular el envío de presupuestos base.",
        variant: "destructive",
      })
      return
    }
    ...
    try {
      ...
      if (result && result.success === false) {
        ...
        toast({
          title: "Envío anulado",
          description: "Se ha anulado el envío del presupuesto base y el estado de la tarea ha sido actualizado.",
        })
        // Refrescamos la página para mostrar los cambios
        router.refresh()
      } else {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-wrap gap-2 w-full sm:w-auto">
          ...
          {/* Botón de enviar (solo admin y si no está aprobado) */}
          ...
          {/* Botón de anular envío (solo admin y si está aprobado) */}
          {isAdmin && presupuesto.aprobado && (
            <Button
          ...
          <CardContent>
            <dl className="space-y-3">
              ...
              {presupuesto.fecha_aprobacion && (
                <div>
                  <dt className="text-sm font-medium text-muted-foreground">Fecha de Envío</dt>
