...
// Forzar el renderizado dinámico para esta página.
// Esto es crucial porque la página depende de la sesión del usuario (cookies),
// que solo está disponible en tiempo de ejecución y no durante la compilación estática.
