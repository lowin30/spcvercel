...
import { MapPin, Building2, Copy, Map, Edit2, Eye } from "lucide-react"
...
export function BuildingList({ buildings, onBuildingUpdated, permissions }: BuildingListProps) {
          ...
          >
            <CardContent className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2">
                ...
                {/* 🛡️ TERCERA BARRERA: Botón Editar protegido */}
                ...
                <Button
                  ...
                  asChild
                  className="h-9"
                  style={{ gridColumn: !permissions?.canEditBuilding && !building.mapa_url ? 'span 2' : 'auto' }}
                >
