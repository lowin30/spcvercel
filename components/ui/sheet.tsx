...
>(({ side = "right", className, children, ...props }, ref) => {
  // Verificar si ya hay un SheetTitle en los children
  const hasSheetTitle = React.Children.toArray(children).some(
    (child) => {
      if (React.isValidElement(child)) {
        // Verificar si el componente es un SheetHeader
        if (child.type === SheetHeader) {
          // Buscar SheetTitle dentro de los hijos de SheetHeader
        ...
        // Verificar si el componente es un SheetTitle
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        {...props}
      >
        {/* Agregar un SheetTitle y Description ocultos si no hay uno en los children */}
        {!hasSheetTitle && (
          <>
            ...
            <SheetPrimitive.Description className="hidden">
              <VisuallyHidden>Contenido del panel</VisuallyHidden>
